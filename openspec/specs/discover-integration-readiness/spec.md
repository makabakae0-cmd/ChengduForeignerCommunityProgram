# discover-integration-readiness Specification

## Purpose
Define local/API readiness requirements for discover content, including visible-only public reads, deterministic post creation state, comment availability, reporting, and moderation.
